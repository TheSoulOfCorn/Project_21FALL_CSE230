...
updatePlantFert x = 
  case x of  
    ...
    Good_w_nfR  -> Just GrownR
    Good_nw_nfA -> Just Good_nw_fA
    Good_w_nfA  -> Just GrownA
    _           -> Just Bad
...
putSleep board e pos =  result board

putEat :: Board -> Score -> Pos -> Result Board
putEat board sc pos =  result board
